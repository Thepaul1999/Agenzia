...
export default async function AdminNewImmobilePage() {
    ...
    <>
      ...
      <div className="edit-page">
        <div className="edit-header">
          ...
          <div>
            <h1 className="edit-title">Nuovo immobile</h1>
            <p className="edit-subtitle">Compila i campi per aggiungere un immobile al catalogo</p>
          </div>
        </div>
